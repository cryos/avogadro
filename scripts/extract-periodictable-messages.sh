#!/bin/sh
BASEDIR="../avogadro/periodictable"	# root of translatable sources
PROJECT="libqperiodictable"	# project name
...
I18NDIR="i18n/libqperiodictable"          # i18n dir
...
sed -e "s/SOME DESCRIPTIVE TITLE/Translations for the QPeriodicTable library/" <${PROJECT}.pot >${PROJECT}.new
...
catalogs=`find . -name 'libqperidictable*.po'`
