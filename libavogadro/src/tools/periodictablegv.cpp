...
namespace Avogadro {
  ...
  ElementItem::ElementItem(int elementNumber) : m_width(26), m_height(26)
  {
    ...
    qDebug() << m_symbol << " (" << m_element << "): " << color[0] << ", " << color[1] << ", " << color[2];
  }
                          ...
                          QWidget *)
  {
    ...
    if (isSelected()) {
      qDebug() << "Element " << m_symbol << " selected.";
                          ...
                          QWidget *)
  {
    ...
    QRectF massNumberRect(-m_width/2, pixelHeight*0.5, m_width, pixelHeight);
    painter->drawText(massNumberRect, Qt::AlignCenter, mass);
    
    QRectF nameRect(-m_width/2, pixelHeight*1.5, m_width, pixelHeight);
