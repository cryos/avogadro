...
namespace Avogadro
{
  ...
  OrbitalExtension::OrbitalExtension(QObject* parent) : Extension(parent),
    m_glwidget(0), m_orbitalDialog(0), m_molecule(0), m_basis(0), m_timer1(0),
    m_timer2(0)
  {
...
/*
    // Calculate a whole cube for each shell in parallel...
    ...
    m_basis->watcher().waitForFinished();
...
//    m_basis->watcher2().waitForFinished();
