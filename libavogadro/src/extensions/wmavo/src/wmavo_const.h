...
#define PLUGIN_WM_VIBRATION_ONOFF false
...
#define WMAVO_CURSOR_CALIBRATION_Z 1.5 // 1.8 // 2.0

#define WMAVO_CAM_CALIBRATION_ZOOM_DISTANCE 0.1
#define WMAVO_CAM_CALIBRATION_ROTATION 9.5 // 10.0
...
#define WMTOOL_POINTSIZE_RATIO_DEFAULT 1.2f //1.0f
