...
namespace Avogadro
{
  class CBAbstractEditor;

  struct CBUnitCellParameters {
    double a, b, c, alpha, beta, gamma;
    CBUnitCellParameters(double _a,double _b,double _c,
                       double _al,double _be,double _ga) {
      a=_a;b=_b;c=_c;alpha=_al;beta=_be;gamma=_ga;};
    CBUnitCellParameters() {
  ...
  public slots:
    ...
    CBUnitCellParameters currentCellParameters();
    ...
    void setCurrentCellParameters(const CBUnitCellParameters&);
  ...
  private:
    ...
    QList<CBAbstractEditor*> m_editors;
    Molecule *m_molecule;
