...
namespace Avogadro
{
  ...
  CBAbstractEditor::CBAbstractEditor(CrystallographyExtension *ext,
                                     QMainWindow *w)
    : QDockWidget(w),
      m_ext(ext),
      m_isLocked(false)
  ...
  CBAbstractEditor::~CBAbstractEditor()
  {

  }

  void CBAbstractEditor::closeEvent(QCloseEvent *event)
  {
    emit visibilityChanged();
    QDockWidget::closeEvent(event);
  }

  void CBAbstractEditor::hideEvent(QHideEvent *event)
  {
    emit visibilityChanged();
    QDockWidget::hideEvent(event);
  }

  void CBAbstractEditor::showEvent(QShowEvent *event)
  {
    emit visibilityChanged();
    QDockWidget::showEvent(event);
  }

  void CBAbstractEditor::storeDockWidgetArea(Qt::DockWidgetArea a)
  {
    QSettings settings;
  ...
  Qt::DockWidgetArea CBAbstractEditor::preferredDockWidgetArea()
  {
    QSettings settings;
