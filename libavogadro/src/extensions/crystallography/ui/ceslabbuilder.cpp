...
namespace Avogadro
{
  ...
  void CESlabBuilder::readSettings()
  {
    ...
    ui.spin_mi_m->setValue(settings.value("mi_m", 0).toInt());
    ui.spin_mi_n->setValue(settings.value("mi_n", 0).toInt());
  ...
  void CESlabBuilder::writeSettings()
  {
    ...
    settings.setValue("mi_m", ui.spin_mi_m->value());
    settings.setValue("mi_n", ui.spin_mi_n->value());
