...
namespace Avogadro
{
  ...
  ///@todo Needs to properly implement undo
  ///@todo Needs to remember settings
  ...
  {
    ui.setupUi(this);
    // Hide the miller index warning label
    ///@todo load defaults
  ...
  void CESlabBuilder::updateSlabCell(bool build)
  {
    ...
    */
	...
	m_ext->pushUndo(new CEUndoCommand(*m_beforeState, after,
	tr("Cut Slab From Crystal")));
      ///@todo FIXME: Delete the unit cell for now
      m_ext->hideEditors();
