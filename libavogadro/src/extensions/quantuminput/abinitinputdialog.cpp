...
namespace Avogadro
{
  ...
  QString AbinitInputDialog::saveInputFile(QString inputDeck, QString fileType, QString ext)
  {
...
// Fragment copied from InputDialog
  ...
  QString AbinitInputDialog::generateInputDeck()
  {
    ...
    // TODO: check the box is big enough: get molecule size and add a bit in each direction, or make it a ui input.
    else {
