...
namespace Avogadro
{
    ...
    m_molecule(0)
  {
    ...
    action->setShortcut( tr("Ctrl+B",
			    "Shortcut key for Crystallographic Toolkit") );
  ...
  QUndoCommand* CrystalBuilderExtension::performAction( QAction */*action*/, GLWidget */*widget*/)
  {
    ...
    if (!m_dialog) {
      ...
      connect(m_dialog, SIGNAL(destroyed(QObject*)),
              this, SLOT(onDialogDestruction()));
    }
  ...
  void CrystalBuilderExtension::onDialogDestruction() {
    m_dialog = 0;
  }
