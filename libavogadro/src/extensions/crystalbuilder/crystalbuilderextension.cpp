...
namespace Avogadro
{
    ...
    m_molecule(0)
  {
    ...
    action->setText(tr("&Crystallographic Toolkit"));
  ...
  QString CrystalBuilderExtension::menuPath
  ...
  QUndoCommand* CrystalBuilderExtension::performAction
  (QAction */*action*/, GLWidget */*widget*/)
  {

    QUndoCommand *undo = NULL;

    if (!m_dialog) {
      m_dialog = new CrystalBuilderDialog
...
Q_EXPORT_PLUGIN2(crystalbuilderextension,
                 Avogadro::CrystalBuilderExtensionFactory)
