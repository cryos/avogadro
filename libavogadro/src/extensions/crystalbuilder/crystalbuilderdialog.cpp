...
namespace Avogadro {
  ...
  {
    // m_actionUnitsLengthGroup->blockSignals(true);
    // m_actionUnitsLengthAngstrom->blockSignals(true);
    // m_actionUnitsLengthBohr->blockSignals(true);
    switch (lengthUnit()) {
    case Angstrom:
      m_actionUnitsLengthAngstrom->setChecked(true);
    ...
    // m_actionUnitsLengthGroup->blockSignals(false);
    // m_actionUnitsLengthAngstrom->blockSignals(false);
    // m_actionUnitsLengthBohr->blockSignals(false);

    // m_actionUnitsAngleGroup->blockSignals(true);
    // m_actionUnitsAngleDegree->blockSignals(true);
    // m_actionUnitsAngleRadian->blockSignals(true);
    switch (angleUnit()) {
    case Degree:
      m_actionUnitsAngleDegree->setChecked(true);
    ...
    // m_actionUnitsAngleGroup->blockSignals(false);
    // m_actionUnitsAngleDegree->blockSignals(false);
    // m_actionUnitsAngleRadian->blockSignals(false);

    // m_actionCoordsCartFracGroup->blockSignals(true);
    // m_actionCoordsCartFracCart->blockSignals(true);
    // m_actionCoordsCartFracFrac->blockSignals(true);
    ...
    // m_actionCoordsCartFracGroup->blockSignals(false);
    // m_actionCoordsCartFracCart->blockSignals(false);
    // m_actionCoordsCartFracFrac->blockSignals(false);

    // m_actionCoordsPreserveGroup->blockSignals(true);
    // m_actionCoordsPreserveCart->blockSignals(true);
    // m_actionCoordsPreserveFrac->blockSignals(true);
    ...
    // m_actionCoordsPreserveGroup->blockSignals(false);
    // m_actionCoordsPreserveCart->blockSignals(false);
    // m_actionCoordsPreserveFrac->blockSignals(false);

    // m_actionMatrixCartFracGroup->blockSignals(true);
    // m_actionMatrixCartFracCart->blockSignals(true);
    // m_actionMatrixCartFracFrac->blockSignals(true);
    ...
    // m_actionMatrixCartFracGroup->blockSignals(false);
    // m_actionMatrixCartFracCart->blockSignals(false);
    // m_actionMatrixCartFracFrac->blockSignals(false);

    // m_actionMatrixVectorGroup->blockSignals(true);
    // m_actionMatrixRowVectors->blockSignals(true);
    // m_actionMatrixColumnVectors->blockSignals(true);
    ...
    // m_actionMatrixVectorGroup->blockSignals(false);
    // m_actionMatrixRowVectors->blockSignals(false);
    // m_actionMatrixColumnVectors->blockSignals(false);
  }
  ...
  void CrystalBuilderDialog::fillUnitCell()
  {
    ...
    for (int i = 0; i < origIds.size(); ++i) {
      ...
      // Seems that this is already in xformed?
      // // Add original atom
      // newFCoords.append(*curVec);
      // newIds.append(*curId);
    }
