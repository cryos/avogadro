...
//      emit primitiveRemoved(ring);
                                            ...
                                            const QList<Bond *> &bonds)
  {
    ...
    //
    // Note (DCL 11/25/11):
    // I benchmarked QHash here, but it scaled terribly when the atom list
    // was large (several minutes tested at 50,000 atoms). This QVector
    // approach may be less memory efficient when ids are spread very far
    // apart, but the speed improvement is enormous.
    //
