...
Botão Esquerdo do Mouse: <byte value="x9"/>Seleciona até dois átomos.
<byte value="x9"/>O primeiro átomo é centrado na origem.
<byte value="x9"/>O segungo átomo é alinhado com o eixo selecionado.
Botão Direito do Mouse: <byte value="x9"/>Reseta o alinhamento.</translation>
    </message>
    <message>
...
Botão Esquerdo do Mouse: <byte value="x9"/>Seleciona até três Átomos.
<byte value="x9"/>Distâncias são medidas entre 1-2 e 2-3
<byte value="x9"/>Ângulo é medido entre 1-3 usando 2 como ponto comum
...
Botão Esquerdo do Mouse: <byte value="x9"/>Clique e Arraste para criar Átomos e Ligações
