/**********************************************************************
StickRender - Renderer for "sticks" display
...
// This is actually the same code as the BSRender::Render code
//  but with very small balls at each atom. Otherwise, the tubes look empty.
GLuint StickRender::Render(OpenBabel::OBMol &mol)
{
  ...
  FOR_BONDS_OF_MOL(b, mol)
    {
      ...
      gluCylinder(q, radius, radius, l1, 8, 1);
